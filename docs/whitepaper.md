...
> **Status:** Skeleton draft, May 14, 2026. Shared for review; treat the
> structure as a placeholder to react against. Scope, requirements, and
> open questions live in the companion doc [`scope.md`](scope.md); please
> react there first before commenting on the paper body.
